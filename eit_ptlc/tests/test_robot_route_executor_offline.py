...
from eit_ptlc.operation.robot_routes.robot_route import RoutePlanner  # noqa: E402
from eit_ptlc.operation.robot_routes.robot_route_executor import (  # noqa: E402
    RouteExecutionError,
    RouteExecutor,
)
...
class RouteExecutorTests(unittest.TestCase):
    ...
    def test_requested_stop_blocks_every_subsequent_step(self) -> None:
        ...
        self.assertEqual(caught.exception.failed_step, "scrape-pick")
